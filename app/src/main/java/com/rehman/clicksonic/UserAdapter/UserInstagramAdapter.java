package com.rehman.clicksonic.UserAdapter;
...
public class UserInstagramAdapter extends RecyclerView.Adapter<UserInstagramAdapter.viewHolder> {
    Context context;
    ArrayList<YouTubeModel> mYouTubeList;

    public UserInstagramAdapter(Context context, ArrayList<YouTubeModel> mYouTubeList) {
    ...
    @NonNull
    @Override
    public UserInstagramAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull UserInstagramAdapter.viewHolder holder, int position) {
        ...
        holder.card_pendingAdp.setVisibility(View.GONE);
...
//                    });
//        });
        holder.card_approvedAdp.setVisibility(View.GONE);
...
//                    });
//        });
        holder.card_rejectedAdp.setVisibility(View.GONE);
