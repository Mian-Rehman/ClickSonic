...
public class UserYouTubeAdapter extends RecyclerView.Adapter<UserYouTubeAdapter.viewHolder> {
    Context context;
    ArrayList<YouTubeModel> mYouTubeList;

    public UserYouTubeAdapter(Context context, ArrayList<YouTubeModel> mYouTubeList) {
    ...
    @NonNull
    @Override
    public UserYouTubeAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull UserYouTubeAdapter.viewHolder holder, int position) {
