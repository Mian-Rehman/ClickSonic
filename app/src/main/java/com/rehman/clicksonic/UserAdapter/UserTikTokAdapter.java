...
public class UserTikTokAdapter extends RecyclerView.Adapter<UserTikTokAdapter.viewHolder> {
    Context context;
    ArrayList<YouTubeModel> mYouTubeList;

    public UserTikTokAdapter(Context context, ArrayList<YouTubeModel> mYouTubeList) {
    ...
    @NonNull
    @Override
    public UserTikTokAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull UserTikTokAdapter.viewHolder holder, int position) {
