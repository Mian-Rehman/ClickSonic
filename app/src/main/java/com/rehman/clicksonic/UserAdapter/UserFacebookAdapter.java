...
public class UserFacebookAdapter extends RecyclerView.Adapter<UserFacebookAdapter.viewHolder> {
    ...
    public UserFacebookAdapter(Context context, ArrayList<YouTubeModel> mYouTubeList) {
    ...
    @NonNull
    @Override
    public UserFacebookAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull UserFacebookAdapter.viewHolder holder, int position) {
