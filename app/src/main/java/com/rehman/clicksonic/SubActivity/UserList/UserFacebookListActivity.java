...
import com.rehman.clicksonic.UserAdapter.UserFacebookAdapter;

import java.util.ArrayList;

public class UserFacebookListActivity extends AppCompatActivity {
    CardView card_pending,card_approved,card_rejected;
    ImageView back_image;
    TextView totalCount,tv_status;
    RecyclerView recyclerView;
    UserFacebookAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_facebook_list);
    ...
    private void rejectedOrders() {
        ...
        adapter = new UserFacebookAdapter(this,mDataList);
