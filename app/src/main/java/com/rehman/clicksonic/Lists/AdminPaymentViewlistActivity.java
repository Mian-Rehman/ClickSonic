...
import com.rehman.clicksonic.Adapter.AdminPaymentAdapter;
import com.rehman.clicksonic.Model.PaymentModel;
import com.rehman.clicksonic.R;

import java.util.ArrayList;

public class AdminPaymentViewlistActivity extends AppCompatActivity {
    CardView card_pending,card_approved,card_rejected;
    ImageView back_image;
    TextView totalCount,tv_status;
    RecyclerView recyclerView;
    AdminPaymentAdapter adapter;
    ArrayList<PaymentModel> mDataList = new ArrayList<>();
    FirebaseAuth mAuth;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_payment_viewlist);
    ...
    private void rejectedOrders() {
        ...
        adapter = new AdminPaymentAdapter(this,mDataList);
