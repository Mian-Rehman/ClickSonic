...
public class TikTokAdapter extends RecyclerView.Adapter<TikTokAdapter.viewHolder> {
    ...
    public TikTokAdapter(Context context, ArrayList<YouTubeModel> mYouTubeList) {
    ...
    @NonNull
    @Override
    public TikTokAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TikTokAdapter.viewHolder holder, int position) {
